...
bgMain.src = "images/menuscreen.png";
cookieSprite.src = "images/goomba.png";
endscreen.src = "images/endscreenbg.jpg";
playersprite.src = "images/playership2.png";
...
function PlayerShip(){
    ...
    this.draw = function(){
      ...
      //  ctx.lineTo(-10, 10);
       // ctx.lineTo(0, -10);
      //  ctx.closePath();
        ctx.drawImage(playersprite, -this.w/2, -30, this.w, this.h);
        ctx.fill();
...
gameStates[0] = function(){
    ...
    ctx.fillText("Avoid all the Goombas!", c.width/2, c.height/2 - 30);
    ctx.font = "15px Arial";
...
gameStates[2] = function(){
    if(score > highScore){
        ...
        ctx.fillStyle = "white";
        ctx.textAlign = "center"
        ctx.fillText("Your score was: " + score.toString(), c.width/2, c.height/2 - 220);
        ctx.fillText("Your New High Score is: " + highScore.toString() , c.width/2, c.height/2 - 180);
        ctx.fillText("New Record!", c.width/2, c.height/2 - 255);
        ...
        ctx.textAlign = "center"
        ctx.fillText("Your score was: " + score.toString(), c.width/2, c.height/2 - 220);
        ctx.fillText("Your high Score is: " + highScore.toString(), c.width/2, c.height/2 - 180);
        ctx.font = "15px Russo One";
        //ctx.fillText("Press Enter to Start", c.width/2, c.height/2 + 20);
        //ctx.drawImage(endscreen,0,0,c.width,c.height);
        ctx.restore();
